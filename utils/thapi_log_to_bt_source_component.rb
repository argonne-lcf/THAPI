...
def get_values(name, value)
  if !name.end_with?('_vals') or !value.strip.start_with?('[')
...
def get_fields(model, event_name, _stream_class = 0)
  fields = {}
  ...
  field_class = eclass[:payload_field_class][:members].to_h do |field_info|
