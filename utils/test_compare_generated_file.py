...
filenames = []
filenames += ["mpi/tracer_mpi.c", "mpi/mpi_library.rb", "mpi/btx_mpi_model.yaml"]
# filenames += ["mpi/mpi_api.yaml"]

filenames += ["omp/tracer_ompt.c", "omp/omp_library.rb", "omp/btx_omp_model.yaml"]
# filenames += ["omp/ompt_api.yaml"]

filenames += ["hip/tracer_hip.c", "hip/hip_library.rb", "hip/btx_hip_model.yaml"]
# filenames += ["hip/hip_api.yaml"]

filenames += ["cuda/tracer_cuda.c", "cuda/cuda_library.rb", "cuda/btx_cuda_model.yaml"]
