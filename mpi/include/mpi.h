...
int PMPI_Group_range_excl(MPI_Group group, int n, int *ranges, MPI_Group *newgroup);
int PMPI_Group_range_incl(MPI_Group group, int n, int *ranges, MPI_Group *newgroup);
