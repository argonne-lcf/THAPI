...
SUPPORTED_EXTENSION_FUNCTIONS = /clCreateProgramWithILKHR|clTerminateContextKHR|clCreateCommandQueueWithPropertiesKHR|clEnqueueMigrateMemObjectEXT|clGetICDLoaderInfoOCLICD|clCreateBufferWithPropertiesINTEL|clCreateImageWithPropertiesINTEL|clGetImageParamsINTEL|clEnqueueVerifyMemoryINTEL|clAddCommentINTEL|clCreatePerfCountersCommandQueueINTEL|clSetPerformanceConfigurationINTEL|clHostMemAllocINTEL|clDeviceMemAllocINTEL|clSharedMemAllocINTEL|clMemFreeINTEL|clGetMemAllocInfoINTEL|clSetKernelArgMemPointerINTEL|clEnqueueMemsetINTEL|clEnqueueMemFillINTEL|clEnqueueMemcpyINTEL|clEnqueueMigrateMemINTEL|clEnqueueMemAdviseINTEL|clGetDeviceFunctionPointerINTEL|clGetDeviceGlobalVariablePointerINTEL|clGetExecutionInfoINTEL|clEnqueueNDRangeKernelINTEL/
