...
tracer.so: tracer.c opencl_tracepoints.o opencl_profiling.o opencl_source.o opencl_dump.o
	gcc -O3 -Wall -I./ -o tracer.so -shared -fPIC -Wl,--version-script,tracer.map tracer.c opencl_tracepoints.o opencl_profiling.o opencl_source.o opencl_dump.o -llttng-ust -ldl
